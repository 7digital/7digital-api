...
// RequestFailedError
//
// Creates a new RequestFailedError supplied to callbacks when the request to
// the api fails.
//
// - @constructor
// - @param {String} message - Custom error message
// with the url that failed
// - @param {ErrorEvent} errorEvent - The error object send by the failed
// http request.
function RequestFailedError(msg, errorEvent) {
