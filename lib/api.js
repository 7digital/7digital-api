...
function formatApiPath(rootPath, resource, action) {
	var requestPath = '/' + (rootPath ? rootPath + '/' : '') +
		resource;
...
Api.prototype.formatPath = function formatPath(resource, action) {
	return formatApiPath(this.schema.version, resource, action);
};

module.exports.Api = Api;
module.exports.formatApiPath = formatApiPath;
