...
Request.version = require('../assets/7digital-api-schema.json').version;
...
// @param {String} action
Request.formatPath = function (resource, action) {
	var requestPath = '/' + (Request.version ? Request.version + '/' : '') + resource;
