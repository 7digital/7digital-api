...
//
// - @return {Object}
APIRequest.prototype.createHeaders = function () {
	return {
		'host': this.host,
...
// @param {Object} data - hash of the parameters for the request.
// @param {Function} callback
APIRequest.prototype.post = function (url, data, callback) {
...
// @param {Object} data - hash of the parameters for the request.
// @param {Function} callback
APIRequest.prototype.makeRequest = function (url, httpMethod, data, callback) {
