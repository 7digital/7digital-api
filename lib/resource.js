...
// - *accesstoken* - the oauth access token if this resource has 3-legged
//                   endpoints
// - *accesssecret* - the secret if this resource has 3-legged endpoints
...
Resource.prototype.createAction = function (actionDefinition) {
	var fnName = this.chooseMethodName(actionDefinition),
		action = actionDefinition.apiCall || actionDefinition,
		httpMethod = (actionDefinition.method || 'GET').toLowerCase(),
		url;
